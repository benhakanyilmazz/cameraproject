...
#define WIFI_SSID             "ssıd"                    // Kameranın bağlanacağı wifi SSID girilmeli.
#define WIFI_PASSWORD         "password"                   // Kameranın bağlanacağı wifi şifresi girilmeli.

#define emailSenderAccount    "mail adresiniz"       // e-mail gönderimi için gmail port 465 (SSL) kullanılıyorsa, "daha az güvenli uygulama erişimi" aktif edilmeli. https://myaccount.google.com/lesssecureapps?pli=1
#define emailSenderPassword   "google gmail uygulama şifreniz"                    // e-mail şifresi.

#define emailRecipient        "2. mail adresi"   //#define komutu ile birden fazla alıcı tanımlanabilir.
